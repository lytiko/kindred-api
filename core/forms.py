...
class KindredForm(forms.ModelForm):
...
class UserForm(KindredForm):
    """Handles data for a User object. There are a few fields it doesn't allow
    to be modofied, as the User model handles these itself.
    ...
    def __init__(self, data, *args, **kwargs):
        ...
        KindredForm.__init__(self, data, *args, **kwargs)
    ...
    def save(self):
        ...
        if "password" in self.submitted_data:
            user = KindredForm.save(self, commit=False)
